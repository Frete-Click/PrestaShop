<div id="box-frete-click" class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <input type="hidden" name="product-package[0][weight]" value="{number_format($product->weight, 10, ',', '')}" />
        <input type="hidden" name="product-package[0][height]" value="{number_format($product->height/100, 10, ',', '')}" />
        <input type="hidden" name="product-package[0][width]" value="{number_format($product->width/100, 10, ',', '')}" />
        <input type="hidden" name="product-package[0][depth]" value="{number_format($product->depth/100, 10, ',', '')}" />        
